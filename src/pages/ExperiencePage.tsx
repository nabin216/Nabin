...
const ExperiencePage: React.FC = () => {
  return (
    <>
      <SEO 
        title="Experience - Nabin's Portfolio"
        description="View my professional experience, work history, and career achievements in software development, cybersecurity, and entrepreneurship."
        keywords="experience, work history, career, jobs, internships, skills, software development, cybersecurity, entrepreneurship, Nabin, Asadur Zaman Nabin"
        url="https://nabin216.github.io/experience"
      />
      <StructuredData 
        type="WebPage" 
        data={{
      ...
      <Layout>
        <div className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h1 className="text-4xl font-bold text-primary dark:text-white mb-4">Professional Experience</h1>
        ...
        <div className="py-20 bg-white dark:bg-gray-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              ...
              className="text-center mb-12"
            >
              <h2 className="text-3xl font-bold text-primary dark:text-white mb-4">Professional Development</h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-bold text-primary dark:text-white">Technical Skills</h3>
                </div>
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-bold text-primary dark:text-white">Academic Growth</h3>
                </div>
                <p className="text-gray-700 dark:text-gray-300 mb-4">
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-bold text-primary dark:text-white">Certifications</h3>
                </div>
                <p className="text-gray-700 dark:text-gray-300 mb-4">
